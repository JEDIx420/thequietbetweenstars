...
export const CHAPTER_1_BEATS: Record<StoryBeatId, BeatDefinition> = {
  ...
  beat_1_first_whisper: {
    ...
    chapter: 1,
    title: 'First Whisper',
    objective: 'Locate and perform a multi-stage scan on the Resonance Echo in the system.',
    loreEntryId: 'log_first_whisper',
    dialogueSpeaker: 'Ship Interface: Mnemosyne',
    dialogueLines: [
      'Target acquired ahead. Sensor array indicates an acoustic resonance monolith.',
      'Close distance within 350u to execute core harmonic probe and recover structural telemetry.',
    ],
    codexReward: {
  ...
  beat_2_station_contact: {
    ...
    objective: 'Navigate to Research Outpost Epsilon-7 and dock at the main concourse.',
    loreEntryId: 'log_station_contact',
    dialogueSpeaker: 'Station Traffic Control',
    dialogueLines: [
      'Approaching vessel, you are cleared for docking bay 3 at Outpost Epsilon-7.',
  ...
  beat_3_fragment_alpha: {
    ...
    dialogueLines: [
      ...
      'However, this harmonic wave is only half the chord. An old survey recon craft, Alpha-9, went dark near the outer system.',
  ...
  beat_4_decryption: {
    ...
    objective: 'Access the Signal Lab at Epsilon-7 or Ship Archive to decrypt the combined fragments.',
  ...
  beat_5_relay_coordinates: {
    ...
    objective: 'Warp to the coordinates of the First Harmonic Relay in deep space.',
    loreEntryId: 'log_relay_approach',
    dialogueSpeaker: 'Ship Interface: Mnemosyne',
    dialogueLines: [
      'We have arrived at the designated coordinates. Megastructure detected.',
